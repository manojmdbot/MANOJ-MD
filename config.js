...
module.exports = {
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "917005439105",
  //========================================- OTHER - CONFIGS -=====================================================================
  ...
  packname: process.env.packname || "MANOJ TECH",
  author: process.env.author || "MANOJ TECH",
  //==========================================- API-CONFIGS -==========================================================
...
//------------------------------------------------------------------------------------------------------------------
  ...
  START_MSG: process.env.START_MSG || `🚀 *_MANOJ-MD Connected Successfully!_* ✅ 

--- *👨‍💻🎉 _Welcome to MANOJ-MD!_* 🎉💗 

*🔹 OWNER:* 917005439105

_Thank you for using_ *👨‍💻MANOJ-MD💗.*
_We're here to make your experience enjoyable and seamless._
_If you need any help or have questions, don't hesitate to ask._ 🌝💗

*🖇️Join My WhatsApp Channel✓💗 - :* https://whatsapp.com/channel/0029VaT1ewtI1rcbm9xB4s0U

*🖇️Subscribe My Youtube Channel✓💗 - :* https://www.youtube.com/@virallteech

*🖇️Fork & Star My Repo✓💗 - :* https://github.com/manojmdbot/MANOJ-MD

*🖇️Follow My Github Account✓💗 - :* https://github.com/manojmdbot

_*👨‍💻 Enjoy your time with us! 😊*_

> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍᴀɴᴏᴊ ᴛᴇᴄʜ*` ,

  ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/kukiqn.jpg",
  MENU_IMG: process.env.MENU_IMG || "https://files.catbox.moe/kukiqn.jpg",
